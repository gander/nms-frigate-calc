...
async function handleNonceResponse(response) {
    ...
    newHeaders.set('Content-Security-Policy-Report-Only', `default-src 'self'; script-src 'self' 'unsafe-inline' 'nonce-${nonce}' 'strict-dynamic' http: https:; object-src 'none'; base-uri 'none'; connect-src 'self' https://medama.gander.tools/ https://sentry.gander.tools/; style-src 'self' 'unsafe-inline' 'nonce-${nonce}'; require-trusted-types-for 'script'; report-to csp-endpoint; report-uri https://csp.gander.tools/`);
